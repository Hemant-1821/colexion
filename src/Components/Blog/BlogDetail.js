            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-8 left-column-details">
                        ...
                        <div className="row ml-1 point-head">
                            <div class="Engaging-with-NFT-Community">
                                Engaging with NFT Community
                            </div>
                        </div>
                        <div class="For-an-Artist">
                        ...
                        <div className="rec-box">
                            ...
                            <div class="To-catch-peoples">
                                To catch people’s attention develop your NFT artworks with amusing concepts that generally attracts people.
                            </div>
                        </div>
                        <div className="row ml-1 point-head">
                            <div class="Engaging-with-NFT-Community">
                    ...
                    <div className="col-md-4">
                        ...
                        <div class="Line-16"></div>
                        <div class="Will-NFT-culture-survive-or-will-the-bubble-burst">
